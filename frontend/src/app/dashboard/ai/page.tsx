...
import { UploadPanel } from '@/src/components/ai/upload-panel'
import { RecentSessions } from '@/src/components/ai/recent-sessions'
import { ChatInterface } from '@/src/components/ai/chat-interface'
import { QuickActions } from '@/src/components/ai/quick-actions'
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 pt-12 lg:pt-0">
          ...
          <div className="grid gap-6 lg:grid-cols-12">
            ...
            <div className="lg:col-span-3">
              <QuickActions
                onAction={(key) => setPendingAction(key)}
              />
            </div>
          </div>
        </div>
